        ...
        <>
            <div className="slider-wrapper">
                ...
                >
                    ...
                    <div>
                        <StaticImage src='../../assets/images/rockvilleSpeakers.png' />
                    </div>
                    <div>
                        <StaticImage src='../../assets/images/wiredMain.png' />
                    </div>
                ...
                <div className="thumbnail-slider-wrap mt-5 ">
                    <Slider
                        ...
                        <div>
                        <StaticImage src='../../assets/images/wiredMain.png'  className='border border-neutral-400' />
                    </div>
                    <div>
                        <StaticImage src='../../assets/images/digitalTransmitter.png'  className='border border-neutral-400' />
                    </div>

                    <div>
                        <StaticImage src='../../assets/images/rockvilleSpeakers.png'  className='border border-neutral-400' />
                    </div>
                    <div>
                        <StaticImage src='../../assets/images/wiredMain.png'  className='border border-neutral-400' />
                    </div>
...
export default OptionTwoslider