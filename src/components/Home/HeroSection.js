        ...
        <HeaderScroll />
            <div className="bg-black relative text-white sm:top-0 sm:-mt-12 ">
                <StaticImage
                    ...
                    alt=""
                />
                <StaticImage className="mx-auto w-full lg:hidden" src="../../assets/images/mobile-timberline-outdoor-movie-theater-480x240.jpg" alt="" />
                {/* <div class="absolute inset-0 bg-black opacity-50"></div> */}
                <div className="container pb-4 xl:pb-16 mx-auto">
                    <div className="xl:absolute xl:mt-16 2xl:pt-10 sm:top-0 h-full">
                        <div className="relative xl:w-4/6 2xl:w-3/6 z-20 mt-4 xl:mt-0">
                            <p className="font-semibold text-xl md:text-3xl mb-2 max-w-full">
