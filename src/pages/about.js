...
const AboutPage = () => (
  <Layout>
      ...
      <div className="container max-w-4xl mx-auto top-heading px-5">
        <h1 className="text-orange-500 md:text-5xl text-4xl ml-2 mt-6">
          <span className="about">About</span>
        </h1>
      </div>
      {/* </div> */}
      <div className="container max-w-4xl mx-auto xl:pt-0 px-5">
        <StaticImage src="../assets/images/todd-morton-founder.png" alt="" className="w-full" />
        <p className="image-text-color image-text-press-1 text-sm pt-3 ml-2 max-w-full">
          Todd Morton, founder of the Wireless Outdoor Cinema Company.
        </p>
      </div>
      <div className="container max-w-4xl mx-auto mobile-padding px-5">
        <div className="pt-1 mt-6">
          <p className="mb-4 ml-2 max-w-full">
      ...
      <div className="mt-8 sm:mt-16 bg-orange-1000 py-6 text-center md:hidden block">
        <div className="container mx-auto px-5 text-lg sm:text-3xl leading-tight pt-1 quote py-6 when-build">
        ...
        <StaticImage
          ...
          className="h-10 mt-3 mx-auto signature-white hidden"
        />
        <StaticImage
      ...
      <div className="container max-w-4xl px-5 mx-auto mobile-padding">
      ...
      <div className="container max-w-4xl px-5 mx-auto xl:pt-8 desktop">
      ...
      <div className="container max-w-4xl px-5 mx-auto xl:pt-4 desktop">
      ...
      <div className="container max-w-4xl px-5 mx-auto mobile-padding thankyou">
        <div className="mt-6 ml-2">
          <p className="mb-4 max-w-full">
          ...
          <p className="mb-4 max-w-full">My best,</p>
          <StaticImage src="../assets/images/signature_black.png" className="h-10 mb-16" />
        </div>
      </div>
    </Layout>
)
