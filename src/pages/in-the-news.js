...
const IntheNewsPage = () => {
  return (
    <Layout bgcolor="bg-gray-100">
      <>
        <Breadcrumbs page_title={"In the News"} />
          ...
          <div className="max-w-7xl px-5 mx-auto">
            <div className="pt-5">
              ...
              <div className="mt-8 hidden md:flex">
                <div className="w-7/12 lg:pr-12 pr-6 block">
                  <div
                    ...
                    onClick={() => navigate("/november-30-press-release")}
                    aria-hidden="true"
                  >
                    <StaticImage
                    ...
                    <div className="bg-white pt-5 px-5 cursor-pointer rounded-b-lg">
                      ...
                      <p className="text-xl leading-tight pt-5 font-bold mb-0 max-w-full text-lg">
                        Wireless Outdoor Cinema Company introduces new
                        Timberline Streamline Free-Standing Screen Frame System
                      </p>
                      <p className="text-gray-600 pt-5 pb-5 mb-0 max-w-full text-lg">
                        November 30, 2023
                      </p>
                    </div>
                  </div>
                ...
                <div
                  className="flex-1 lg:pl-12 pl-6 md:border-l border-gray-400"
                    ...
                    >
                      ...
                      <div className="ml-6 flex flex-col justify-between text-lg">
                        <h4 className="text-gray-600">
                          Sun Journal News Article
                        </h4>
                        <h3 className="text-gray-800 font-bold press-release-lineHeight">
                          Film buff's inspiration inspires backyard theater
                          business
                        </h3>
                        <h4 className="text-gray-600 font-thin">
                          October 10, 2021
              ...
              <div className="mt-8 flex flex-col items-center md:hidden">
                ...
                >
                  <StaticImage
                    src="../assets/images/mobile-news-nov30-2023-outdoor-movie-theater-screen-frame-362x204.png"
                    alt="November 30, 2023, press release announcing the new Timberline Free-Standing Screen Frame and Outdoor Movie Theater."
                ...
                >
                  <StaticImage
                    src="../assets/images/mobile-news-mar2-2023-outdoor-movie-theater-screen-frame-362x204.png"
                    alt="March 2, 2023, press release announcing the new Timberline Cemented Screen Frame and Outdoor Movie Theater."
                    className="w-full shadow-xl"
                  />
                  <div className="bg-white pt-5 px-3 cursor-pointer rounded-b-lg">
                ...
                >
                  <StaticImage
                    src="../assets/images/mobile-news-aug28-2022-outdoor-movie-theater-screen-frame-362x204.png"
                    alt="August 28, 2022, press release notification of new supports to the Timberline Movable Screen Frame and Outdoor Movie Theater."
                    className="w-full"
                  />
                  <div className="bg-white pt-5 px-3 cursor-pointer rounded-b-lg">
                ...
                >
                  <StaticImage
                    src="../assets/images/mobile-news-jun30-2022-outdoor-projector-stand-362x204.png"
                    alt="June 30, 2022, press release unveiling the new Timberline Outdoor Movie Theater Projector Stand."
                    className="w-full"
                  />
                  <div className="bg-white pt-5 px-3 cursor-pointer rounded-b-lg">
                ...
                >
                  <StaticImage
                    src="../assets/images/mobile-news-jan4-2021-outdoor-movie-theater-winner-362x204.png"
                    alt="January 4, 2021, press release announcing 107.5 Frank FM Fantasy Pro Football Challenge winner of the Outdoor Movie Theater."
                    className="w-full"
                  />
                  <div className="bg-white pt-5 px-3 cursor-pointer rounded-b-lg">
                    ...
                    <p className="text-gray-600 pt-1 pb-3 text-lg mb-0">
                      January 4, 2021
                    </p>
                  </div>
                </Link>
                ...
                >
                  <StaticImage
                    src="../assets/images/mobile-news-jun25-2020-todd-morton-founder-362x204.png"
                    alt="June 25, 2020, Bridgton News interview with Todd Morton, founder of the Wireless Outdoor Cinema Company."
                    className="w-full"
                  />
                  <div className="bg-white pt-5 px-3 cursor-pointer rounded-b-lg">
                ...
                >
                  <StaticImage
                    src="../assets/images/mobile-news-jun8-2020-wireless-outdoor-cinema-company-362x204.png"
                    alt="June 08, 2020, press release introducing the Wireless Outdoor Cinema Company."
                    className="w-full"
                  />
                  <div className="bg-white pt-5 px-3 cursor-pointer rounded-b-lg">
