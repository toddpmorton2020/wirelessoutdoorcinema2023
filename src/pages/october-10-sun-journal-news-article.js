                ...
                <div className="pt-5 overflow-hidden">
                    <div className="max-w-3xl px-5 mx-auto">
                        ...
                        <div className="press-release-padding sm:block hidden py-5">
                            <p className="text-xl image-text-color max-w-full mb-0">SUN JOURNAL</p>
                            <p className="text-xl image-text-color max-w-full mb-0">October 10, 2021</p>
                            <p className="text-xl pt-5 image-text-color max-w-full mb-0">
                                By Kathryn Skelton – Staff Writer for the Sun Journal
                            </p>
                        </div>
