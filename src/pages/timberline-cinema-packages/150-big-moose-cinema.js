        ...
        <Layout >
            <>
                <div className="wrapper desktop md:block hidden">
                    <div className="max-w-7xl px-5 mx-auto">
                        <div className="py-5 xl:pt-5">
                            ...
                            <div className="mt-12 grid xl:grid-cols-2 grid-cols-1">
                                <div className="mt-6 xl:mt-0 pr-0 xl:pr-12 xl:order-first order-last">
                                    <h1 className="text-orange-500 text-3xl sm:text-5xl leading-none relative mb-0">
                                        150” Big Moose
                                    </h1>
                                    <h1 className="text-black text-3xl sm:text-5xl leading-none relative mb-0">
                                        Outdoor Cinema
                                    </h1>
                                    <h2 className="text-2xl sm:text-3xl mt-3 leading-tight medium-text mb-8">
                                    ...
                                    <h2 className="text-2xl sm:text-3xl mt-3 leading-tight medium-text">
                    ...
                    <div className="w-full py-10 my-10 bg-gray-100 text-center">
                        <h2 className="text-5xl text-orange-500">Option 1: <span className="text-black">Go Wireless</span></h2>
                    </div>
                    ...
                    <div className="max-w-7xl px-5 mx-auto">
                        <div className="grid xl:grid-cols-2 grid-cols-1 ">
                            ...
                            <div className="flex-1 mt-6 xl:mt-0 rightContainer xl:pl-12 description-container">
                                ...
                                <p className="mb-2 text-md max-w-full mb-0">
                                ...
                                <h3 className="sm:text-3xl text-xl lg:py-10 py-5 font-medium">
                                    Wireless Cinema Package Includes
                                </h3>
                                <ul className="list mt-1">
                                    <li className='list-disc mb-0'>Pressure-treated wooden movie frame</li>
                                    <li className='list-disc mb-0'>Wrinkle-free Cinematic Screen with black backing</li>
                                    <li className='list-disc mb-0'>1080p HD Projector with 4,000 Lumens</li>
                                    <li className='list-disc mb-0'>Bluetooth Sound bar Speaker</li>
                                    <li className='list-disc mb-0'>Chargeable Off-Grid Battery Station</li>
                                    <li className='list-disc mb-0'>Roku Express 4k Player with voice control</li>
                                    <li className='list-disc mb-0'>Custom Cedar Equipment Stand</li>
                                    <li className='list-disc mb-0'>Friendly and Professional Installation</li>
                                </ul>
                                <div className="mt-4 flex justify-between prices items-center">
                                    <div className="">
                        ...
                        <ProductSection
                            ...
                            content={
                                <div className="grid gap-2 sm:grid-cols-2 mt-4">
                                    <div>
                                        <div className="mb-4">
                                            <h3 className="text-xl sm:text-2xl uppercase  mb-2">
                                                Wooden Frame For Screen
                                            </h3>
                                            <div className="mb-2 flex items-start">
                                                <StaticImage src="../../assets/images/icons/checkmark.png" className="mr-3 " />
                    ...
                    <div className="w-full py-10 my-10 bg-gray-100 text-center">
                        <h2 className="text-5xl text-orange-500">Option 2: <span className="text-black">Go Wired</span></h2>
                    </div>

                    <div className='max-w-7xl mx-auto px-5'>
                        <div className="grid xl:grid-cols-2 grid-cols-1">
                            <div className="flex-1 mt-6 xl:mt-0 pr-0 xl:pr-12 xl:pb-0 pb-10">
                                <h2 className="sm:text-3xl text-xl product-title mb-3">
                                    Get a year-round Backyard Outdoor Cinema
                                </h2>
                                <p className="mb-0 max-w-full text-md">
                                ...
                                <h3 className="sm:text-3xl text-xl lg:py-10 py-5">
                                    Wired Cinema Package Includes
                                </h3>
                                <ul className="list">
                                    <li className='mb-0 list-disc'>Pressure-treated wooden movie frame</li>
                                    <li className='mb-0 list-disc'>Wrinkle-free Cinematic Screen with black backing</li>
                                    <li className='mb-0 list-disc'>1080p HD Projector with 4,000 Lumens</li>
                                    <li className='mb-0 list-disc'>Rockville 8“ Dual Speakers with Tripod Stands</li>
                                    <li className='mb-0 list-disc'>
                                        Rolls Digital FM Transmitter connects your speakers to the
                                        projector
                                    </li>
                                    <li className='mb-0 list-disc'>Roku Express 4k with voice control</li>
                                    <li className='mb-0 list-disc'>25'ft. Extension Cord and Waterproof Surge Strip</li>
                                    <li className='mb-0 list-disc'>
                                        Custom Cedar Equipment Stand with pivoting shelf for
                                        projector
                                    </li>
                                    <li className='mb-0 list-disc'>Friendly and Professional Installation</li>
                                </ul>
                        ...
                        <div className="w-full py-16 text-center">
                            <h2 className="text-5xl text-orange-500">How to operate your <span className="text-black">Outdoor Cinema</span></h2>
                        </div>
                        ...
                        <div className="w-full py-16 text-center">
                            <h2 className="text-5xl text-orange-500">Outdoor Projector <span className="text-black">various connections</span></h2>
                        </div>
                        ...
                        <div className="mb-20">
                            ...
                            <div className="mt-4 various-connections">
                                <div className="mb-6 flex items-start">
                                    <div><StaticImage src="../../assets/images/icons/checkmark.png" className="mr-3 w-5 h-5" width={20} height={20} /></div>
                                    <span>
                    ...
                    <div className="max-w-7xl px-5 mx-auto">
                        <div className="py-6">
                            ...
                            <div className="mt-12 flex flex-col-reverse md:flex-row mb-8">
                                <div className="mt-6">
                                    <h1 className="text-orange-500 text-3xl sm:text-4xl leading-none mb-0 font-bold relative heading">
                                        150” Big Moose
                                    </h1>
                                    <h1 className="text-black text-3xl sm:text-4xl leading-none mb-0 font-bold relative heading">
                                        Outdoor Cinema
                                    </h1>
                                    <h2 className="text-2xl sm:text-xl mt-3  leading-tight">
                                        Standing at 12’ ft. wide and 10’ ft. high, this massive
                                        viewing screen is for the homeowner who wants the biggest and
                                        best. And perfect for business owners who want to attract more
                                        customers to their place of business with outdoor seating.
                                        ...
                                        <div className="flex flex-col-reverse md:flex-row secondContainer">
                                            <div className="flex-1 pl-0 md:pl-12 text-center md:text-left firstWrap leftContainer">
                                                ...
                                                <div className="flex mt-2 mb-10">
                                                    <Link to="tel:2075952960" className='bg-orange-500 text-white py-4 px-8 uppercase font-bold rounded duration-300 transition hover:bg-orange-600 no-underline'>Call Today</Link>
                                                </div>
                                                <ProductSection
                                ...
                                <ProductSection
                                    ...
                                    content={
                                        <div className="mt-12  flex flex-col-reverse md:flex-row secondContainer">
                                            <div className="flex-1 mt-6 md:mt-0 pr-0 md:pr-12 mb-6 xl:pb-0 pb-10">
                                                <h2 className="text-xl sm:text-3xl font-bold product-title mb-4">
