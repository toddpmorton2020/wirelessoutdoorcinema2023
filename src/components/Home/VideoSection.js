...
const VideoSection=() =>{
    return(
        <div className="bg-black pt-6 xl:pt-10 xl:pb-36">
        <div className="max-w-5xl mx-auto">
          <div className="flex md:flex-col flex-col-reverse container mx-auto px-5 how-to">
            <div className="pb-6 text-white ">
              ...
              This revolutionary outdoor movie theater has the fastest setup time, the most durable frame system, never has to be broken down, and is built to be used year-round. Transform your backyard into an entertainment destination. Watch to learn more.
              </p>
