...
const October10PressRelease = () => {
    return (
        <Layout bgcolor="sm:bg-white bg-grey-10">
            <Breadcrumbs page_title={"October 10 News Article"} />
            <div className="pb-12">
                <div className="pt-5 overflow-hidden">
                    <div className="max-w-3xl px-5 mx-auto">
                        <div className="sm:hidden block text-center">
                            <p className="text-grey-100 text-base pt-6 mb-0 max-w-full">
                                SUN JOURNAL | October 10, 2021
                            </p>
                            <p className="text-grey-100 mb-0 max-w-full">
                        ...
                        <div className="sm:block hidden py-5">
                            ...
                            <p className="text-lg text-neutral-600 max-w-full mb-0">October 10, 2021</p>
                            <p className="text-lg pt-5 text-neutral-600 max-w-full mb-0">
                                By Kathryn Skelton – Staff Writer for the Sun Journal
                            </p>
                        </div>
                        ...
                        <div className="pt-8 sm:text-black text-white">
                            ...
                            <br />
                            <Link
                                className="sm:text-lg sm:text-black text-white text-base no-underline font-normal"
                                to="tel:207-647-8759"
                            >
                                (207) 647-8759
                            </Link>
