...
const BannerCalloutSection = () => {
  const { PdfIcon } = useStaticQuery(
    graphql`
      query {
        PdfIcon: file(relativePath: {eq: "icon-pdf-how-to-build-an-outdoor-movie-theater-107x99.png"}) {
          childImageSharp {
    ...
    <div className="callout bg-gray-990 relative py-9 text-white hidden md:block">
      <div className="max-w-7xl mx-auto grid grid-cols-12 w-full gap-4 px-5">
        <div className="col-span-1">
          <GatsbyImage image={getImage(PdfIcon)} alt="how to build an outdoor movie theater pdf DIY guide icon"
        ...
        <div className="col-span-7 flex flex-col">
          <p className="text-xxs sm:text-xs md:text-lg xl:text-2xl lg:text-2xl font-semibold mb-0 max-w-full">
            <span className="text-orange-1000">Get the</span> only professional DIY{" "}
            <span className="text-orange-1000">on how to build an</span>
          </p>
